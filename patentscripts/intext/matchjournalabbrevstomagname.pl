...
$abbrevsfile="$INPUTDIR_PATENT_DEPENDENCIES" . "wosmagjournalxwalk.tsv";
open(ABBREVS,"$abbrevsfile")||die("Can't open abbreviations file $abbrevsfile\n");

$journalmatchesfile="$INPUTDIR_PATENT_DEPENDENCIES"  . "matchedjournalscolor.tsv";
#$journalmatchesfile="temp";
open(JOURNALMATCHES,"$journalmatchesfile")||die("Can't open Journal Matches file $journalmatchesfile\n");

$outfile="$INPUTDIR_PATENT_DEPENDENCIES" . "matchedjournals_magname.tsv";
